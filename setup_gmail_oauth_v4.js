...
async function screenshot(page, name) {
  const filepath = path.join(SCREENSHOTS_DIR, `v4_${name}_${Date.now()}.png`);
...
async function setupGmailOAuth() {
  console.log('=== Gmail OAuth Setup v4 (No Persistent Context) ===\n');

  // FIXED: Use regular launch() instead of launchPersistentContext()
