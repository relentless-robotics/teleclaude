...
async function main() {
  ...
  try {
    switch (command) {
      case 'create':
        const createPassword = args[1] || 'YOUR_PC_SSH_PASSWORD';
      ...
      case 'import':
        const importPassword = args[1] || 'YOUR_PC_SSH_PASSWORD';
        try {
      ...
      case 'list':
        const listPassword = args[1] || 'YOUR_PC_SSH_PASSWORD';
      ...
      default:
        ...
        console.log('');
        console.log('Default password: YOUR_PC_SSH_PASSWORD');
